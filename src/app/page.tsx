...
export default function Home() {
    return (
        <>
            <section className="flex flex-col w-full h-full mt-4 items-center sm:items-start">
                <div className="flex flex-col gap-4 w-3/4 mt-4 mx-auto items-center sm:items-start">
